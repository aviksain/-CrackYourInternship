...
| 89.|`Medium`|[Copy List with Random Pointer](https://leetcode.com/problems/copy-list-with-random-pointer/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Linked%20LIst/Medium/Copy_List_with_Random_Pointer.cpp)|
| 90.|`Medium`|[Add Two Numbers II](https://leetcode.com/problems/add-two-numbers-ii/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Linked%20LIst/Medium/Add_Two_Numbers_II.cpp)|
| 91.|`Medium`|[Reverse Linked List II](https://leetcode.com/problems/reverse-linked-list-ii/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Linked%20LIst/Medium/Reverse_Linked_List_II.cpp)|
...
| 97.|`Medium`|[Segregate even and odd nodes in a Linked List](https://www.geeksforgeeks.org/segregate-even-and-odd-elements-in-a-linked-list/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Linked%20LIst/Medium/Segregate_even_and_odd_nodes_in_a_Linked_List.cpp)|
| 98.|`Medium`|[Rearrange a given linked list in-place](https://www.geeksforgeeks.org/rearrange-a-given-linked-list-in-place/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Linked%20LIst/Medium/Rearrange_a_given_linked_list_in-place.cpp)|
...
| 100.|`Hard`|[Reverse Nodes in k-Group](https://leetcode.com/problems/reverse-nodes-in-k-group/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Linked%20LIst/Hard/Reverse_Nodes_in_k-Group.cpp)|
| 101.|`Hard`|[Merge Sort for Linked Lists](https://www.geeksforgeeks.org/merge-sort-for-linked-list/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Linked%20LIst/Hard/Merge_Sort_for_Linked_List.cpp)|
| 102.|`Hard`|[Flattening a Linked List](https://www.geeksforgeeks.org/flattening-a-linked-list/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Linked%20LIst/Hard/Flattening_a_Linked_List.cpp)|
...
| 126.|`Easy`|[Convert Sorted Array to Binary Search Tree](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Trees/Easy/Convert_Sorted_Array_to_Binary_Search_Tree.cpp)|
...
| 149.|`Medium`|[Unique Binary Search Trees](https://leetcode.com/problems/unique-binary-search-trees/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Trees/Medium/Unique_Binary_Search_Trees.cpp)|
| 150.|`Medium`|[Recover Binary Search Tree](https://leetcode.com/problems/recover-binary-search-tree/)|[C++](https://github.com/aviksain007/-CrackYourInternship/blob/main/Trees/Medium/Recover_Binary_Search_Tree.cpp)|
